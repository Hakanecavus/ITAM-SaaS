  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-extrabold text-slate-800 dark:text-slate-100 tracking-tight">Yeni Sarf Malzemesi</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Stokta tutulacak yeni bir sarf malzemesi tanımlayın.</p>
        </div>
      </div>
      ...
      <div className="bg-white/70 dark:bg-slate-900/50 backdrop-blur-md p-6 md:p-8 rounded-3xl border border-white/40 dark:border-slate-800 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none">
        <ConsumableForm subdomain={resolvedParams.subdomain} />
      </div>
    </div>
  );
}
